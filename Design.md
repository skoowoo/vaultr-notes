...
- **Brand Accent** (`{colors.brand-accent}` — #cc785c): Used sparely on inline links and on a small badge / "Customer story" highlight. The system is near-monochrome — the coral accent appears rarely.
