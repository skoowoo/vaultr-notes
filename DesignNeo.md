...
## 6.6 切换控件 Segmented / Toggle Control
...
```css
/* 首页 choice-card 标题，"像素感"点缀 */
html[data-theme="neo"] .choice-title {
  font-family: "Press Start 2P", monospace;
  font-size: 0.52rem;
}
```

"Press Start 2P" 仅用于一处微型标签，作为像素风的点睛之笔，不扩散到其他元素。
